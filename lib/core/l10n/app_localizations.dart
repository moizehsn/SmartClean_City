...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _strings = {
    ...
    'fr': {
      ...
      'connectez_vous_pour': 'Connectez-vous pour signaler des déchets.',
      'adresse_email': 'Adresse email',
      'mot_de_passe': 'Mot de passe',
      'mot_de_passe_oublie_point': 'Mot de passe oublié ?',
      'se_connecter_btn': 'Se connecter',
      'pas_de_compte': "Vous n'avez pas de compte ? ",
      's_inscrire': "S'inscrire",
      'creer_compte_titre': 'Créer un Compte',
      'rejoignez_nous_ville': 'Rejoignez-nous pour une ville plus verte.',
      'nom_complet': 'Nom complet',
      'confirmer_mot_de_passe': 'Confirmer le mot de passe',
      'deja_un_compte': 'Vous avez déjà un compte ? ',
      'proprete_ia': "Propreté Urbaine par l'IA",
      'reinitialisation': 'Réinitialisation',
      'entrez_email_reinitialisation': 'Entrez votre adresse email pour recevoir un lien de réinitialisation.',
      'envoyer_lien': 'Envoyer le lien',
      'mot_de_passe_oublie_sans_point': 'Mot de passe oublié',
      // Privacy additions
      'confidentialite_intro': "SmartClean City s'engage à protéger votre vie privée. Cette application collecte des données GPS et des images d'appareil photo uniquement dans le cadre du nettoyage municipal et de la gestion des signalements de déchets.",
      'confidentialite_gps_titre': '1. Données de localisation (GPS)',
      'confidentialite_gps_desc': 'Nous collectons votre position précise en arrière-plan et au premier plan uniquement pour localiser avec exactitude les déchets signalés et guider les camions de nettoyage.',
      'confidentialite_camera_titre': '2. Appareil photo et images',
      'confidentialite_camera_desc': "L'accès à l'appareil photo est requis pour capturer des photos de déchets (avant nettoyage) et des preuves de propreté (après nettoyage).",
      'confidentialite_partage_titre': '3. Partage des données',
      'confidentialite_partage_desc': "Ces données ne sont jamais vendues ou partagées avec des tiers et sont strictement réservées aux services de la ville pour améliorer la propreté urbaine.",
      'confidentialite_charte_titre': "Charte d'utilisation",
      'confidentialite_charte_citoyen': "Les signalements doivent être réels et précis. Tout abus, envoi de photos aléatoires ou fausses alertes entraînera la suspension du compte. Maintenons notre ville propre de manière responsable.",
      'confidentialite_charte_chauffeur': "En tant que chauffeur, vous vous engagez à accomplir les missions avec intégrité. Les photos 'après nettoyage' doivent être d'authentiques preuves de résolution. Toute manipulation ou fausse déclaration sera signalée à l'administration.",
      // Auth Error & Validation additions
      'remplir_tous_champs': 'Veuillez remplir tous les champs.',
      'erreur_connexion_auth': 'Erreur de connexion.',
      'identifiants_incorrects': 'Identifiants incorrects.',
      'erreur_inattendue': 'Erreur inattendue.',
      'mots_de_passe_non_identiques': 'Les mots de passe ne correspondent pas.',
      'mdp_faible': 'Le mot de passe est trop faible.',
      'compte_existe_deja': 'Un compte existe déjà pour cet email.',
      'email_invalide': 'Adresse email invalide.',
      'erreur_survenue': 'Une erreur est survenue.',
      'veuillez_entrer_email': 'Veuillez entrer votre adresse email.',
      'erreur_lien': "Erreur lors de l'envoi du lien.",
      'lien_envoye_msg': 'Un lien de réinitialisation a été envoyé.',
    },
    ...
    'ar': {
      ...
      'statut_en_verification': 'قيد المراجعة',
      ...
      // Auth additions
      'bienvenue_titre': 'مرحباً بك 👋',
      'connectez_vous_pour': 'سجل دخولك للإبلاغ عن النفايات.',
      'adresse_email': 'البريد الإلكتروني',
      'mot_de_passe': 'كلمة المرور',
      'mot_de_passe_oublie_point': 'هل نسيت كلمة المرور؟',
      'se_connecter_btn': 'تسجيل الدخول',
      'pas_de_compte': 'ليس لديك حساب؟ ',
      's_inscrire': 'إنشاء حساب',
      'creer_compte_titre': 'إنشاء حساب',
      'rejoignez_nous_ville': 'انضم إلينا من أجل مدينة أكثر خضاراً.',
      'nom_complet': 'الاسم الكامل',
      'confirmer_mot_de_passe': 'تأكيد كلمة المرور',
      'deja_un_compte': 'لديك حساب بالفعل؟ ',
      'proprete_ia': 'النظافة الحضرية بالذكاء الاصطناعي',
      'reinitialisation': 'إعادة تعيين',
      'entrez_email_reinitialisation': 'أدخل بريدك الإلكتروني لتلقي رابط إعادة التعيين.',
      'envoyer_lien': 'إرسال الرابط',
      'mot_de_passe_oublie_sans_point': 'نسيت كلمة المرور',
      // Privacy additions
      'confidentialite_intro': 'تلتزم منصة SmartClean City بحماية خصوصيتك. يقوم هذا التطبيق بجمع بيانات تحديد الموقع (GPS) والصور من الكاميرا بدقة فقط لأغراض النظافة البلدية وإدارة بلاغات النفايات.',
      'confidentialite_gps_titre': '1. بيانات الموقع (GPS)',
      'confidentialite_gps_desc': 'نحن نجمع موقعك الدقيق في الخلفية والواجهة فقط لتحديد مكان النفايات المبلغ عنها بدقة وتوجيه شاحنات التنظيف.',
      'confidentialite_camera_titre': '2. الكاميرا والصور',
      'confidentialite_camera_desc': 'الوصول إلى الكاميرا مطلوب لالتقاط صور النفايات (قبل التنظيف) وإثباتات النظافة (بعد التنظيف).',
      'confidentialite_partage_titre': '3. مشاركة البيانات',
      'confidentialite_partage_desc': 'لا يتم بيع هذه البيانات أو مشاركتها مع جهات خارجية على الإطلاق، وهي مخصصة حصرياً لخدمات البلدية لتحسين النظافة الحضرية.',
      'confidentialite_charte_titre': 'ميثاق الاستخدام',
      'confidentialite_charte_citoyen': 'يجب أن تكون البلاغات حقيقية ودقيقة. أي إساءة استخدام، أو إرسال صور عشوائية، أو إنذارات كاذبة ستؤدي إلى تعليق الحساب. لنحافظ على نظافة مدينتنا بطريقة مسؤولة.',
      'confidentialite_charte_chauffeur': 'بصفتك سائقاً، فإنك تلتزم بأداء المهام بنزاهة. يجب أن تكون الصور \'بعد التنظيف\' أدلة حقيقية على الإنجاز. سيتم الإبلاغ عن أي تلاعب أو تصريح كاذب للإدارة.',
      // Auth Error & Validation additions
      'remplir_tous_champs': 'يرجى ملء جميع الحقول.',
      'erreur_connexion_auth': 'خطأ في الاتصال.',
      'identifiants_incorrects': 'بيانات الاعتماد غير صحيحة.',
      'erreur_inattendue': 'حدث خطأ غير متوقع.',
      'mots_de_passe_non_identiques': 'كلمتا المرور غير متطابقتين.',
      'mdp_faible': 'كلمة المرور ضعيفة جداً.',
      'compte_existe_deja': 'يوجد حساب بالفعل لهذا البريد الإلكتروني.',
      'email_invalide': 'البريد الإلكتروني غير صالح.',
      'erreur_survenue': 'حدث خطأ ما.',
      'veuillez_entrer_email': 'يرجى إدخال بريدك الإلكتروني.',
      'erreur_lien': 'حدث خطأ أثناء إرسال الرابط.',
      'lien_envoye_msg': 'تم إرسال رابط إعادة التعيين.',
    },
  };
}
