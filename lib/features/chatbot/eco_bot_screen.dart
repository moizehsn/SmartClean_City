...
class _EcoBotScreenState extends State<EcoBotScreen>
  ...
  void initState() {
    ...
    // Welcome message from Eco-Bot
    _messages.add(_ChatMessage(
      text: 'Bonjour ! 🌿 Je suis Eco-Bot, ton assistant écologique. '
  ...
  Future<void> _sendMessage() async {
    ...
    // 2. Send to AI via AiService
    try {
      final botReply = await AiService.sendMessage(text);

      setState(() {
        _messages
            .add(_ChatMessage(text: botReply, isUser: false, time: _now()));
      });
    } catch (e) {
      debugPrint('AI API Error: $e');
      setState(() {
        _messages.add(_ChatMessage(
          text: 'Désolé, j\'ai rencontré un problème de connexion. '
              'Veuillez réessayer. 🔄',
          isUser: false,
          time: _now(),
        ));
            ...
            Column(
              ...
              children: [
                ...
                AnimatedSwitcher(
                  ...
                  child: Text(
                    _isLoading ? 'en train d\'écrire…' : 'IA · En ligne',
                ...
                builder: (_, _) => Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: AppColors.primary
                        .withValues(alpha: 0.3 + _dotControllers[i].value * 0.7),
                  ),
                ),
              );
            }),
